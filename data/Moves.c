...
const MoveSourceEntry sMoveSource[NUM_OF_MOVES + 1] = {
    ...
    [MOVE_FEINT] = {
        ...
        .description = "The fastest attack\\nknown to Pokemon.\\nHits with +3 priority!",
    },
    ...
    [MOVE_MYSTICAL_FIRE] = {
        ...
        .description = "Lowers foe’s Sp. Atk\\nby one stage.",
    },
    ...
    [MOVE_DRAGON_ASCENT] = {
        ...
        .description = "Rayquaza obliterates\\nthe opponent.\\n-1 Def/Sp.Def for\\nthe user.",
    },
