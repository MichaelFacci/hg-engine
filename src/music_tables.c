...
u16 MainMusicComboTable[][2] =
{
    ...
    [ANIM_MUSIC_COMBO_GARDENIA] = {0xFFFF, NWAV_YOU_WILL_KNOW_OUR_NAMES_XC1DE}, //WAS 0x14
    [ANIM_MUSIC_COMBO_MARLON] = {0x15, SEQ_G5_GYM_LEADER},
    [ANIM_MUSIC_COMBO_PLASMA] = {0xFFFF, NWAV_MECHANICAL_RHYTHM},
    ...
    [ANIM_MUSIC_COMBO_TAU] = {0xFFFF, NWAV_MOEBIUS_BATTLE},
    [ANIM_MUSIC_COMBO_GALACTIC] = {0x1D,  NWAV_INCOMING}, //was 0x1D
    ...
    [ANIM_MUSIC_COMBO_CYRUS] = {0xFFFF, NWAV_IMMEDIATE_THREAT},
    [ANIM_MUSIC_COMBO_ROUGHNECK] = {0xFFFF, NWAV_YOU_WILL_KNOW_OUR_NAMES_XC3},
    [ANIM_MUSIC_COMBO_LANCE] = {0xFFFF, NWAV_YOU_WILL_KNOW_OUR_NAMES_XC1DE},
    [ANIM_MUSIC_COMBO_ACE_TRAINER] = {0xFFFF, NWAV_YOU_WILL_KNOW_OUR_NAMES_XC3},
    ...
    [ANIM_MUSIC_COMBO_JOHTO_WILD_BATTLE_38] = {0x26, NWAV_MILLICK_MEADOWS},
    [ANIM_MUSIC_COMBO_GHETSIS] = {0xFFFF, NWAV_IMMEDIATE_THREAT},
    [ANIM_MUSIC_COMBO_GALACTIC_ADMIN] = {0xFFFF, NWAV_DEATHMATCH_WITH_TORNA},
    [ANIM_MUSIC_COMBO_JOHTO_TRAINER] = {0xFFFF, NWAV_NEW_BATTLE_XC3_DLC},
    [ANIM_MUSIC_COMBO_JOHTO_WILD_THEME] = {0xFFFF, NWAV_KEVES_BATTLE},
    [ANIM_MUSIC_COMBO_TRAINER_N] = {0xFFFF, NWAV_BATTLE_TORNA_GOLDEN},
    [ANIM_MUSIC_COMBO_IRIS] = {0xFFFF, NWAV_CHAIN_ATTACK},
...
u8 TrainerClassToMusicCombo[][2] =
{
    ...
    {TRAINERCLASS_ACE_TRAINER_M, ANIM_MUSIC_COMBO_ACE_TRAINER*4},
    {TRAINERCLASS_LEADER_CLAIR, ANIM_MUSIC_COMBO_CLAIR*4},
    {TRAINERCLASS_GARDENIA, ANIM_MUSIC_COMBO_GARDENIA*4},
    ...
    {TRAINERCLASS_TAU, ANIM_MUSIC_COMBO_TAU*4},
    ...
    {TRAINERCLASS_MARS, ANIM_MUSIC_COMBO_GALACTIC_ADMIN*4},
    {TRAINERCLASS_JUPITER, ANIM_MUSIC_COMBO_GALACTIC_ADMIN*4},
    {TRAINERCLASS_TAU, ANIM_MUSIC_COMBO_KAREN*4},
    {TRAINERCLASS_ZINZOLIN, ANIM_MUSIC_COMBO_ZINZOLIN*4},
    {TRAINERCLASS_PLASMA_F, ANIM_MUSIC_COMBO_PLASMA*4},
    {TRAINERCLASS_SATURN, ANIM_MUSIC_COMBO_GALACTIC_ADMIN*4},
    {TRAINERCLASS_MIASMA, ANIM_MUSIC_COMBO_MIASMA*4},
    {TRAINERCLASS_SHADOW_TRIAD, ANIM_MUSIC_SHADOW_TRIAD*4},
    {TRAINERCLASS_ROUGHNECK, ANIM_MUSIC_COMBO_ROUGHNECK*4},
