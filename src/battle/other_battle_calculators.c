...
void LONG_CALL PlayTrainerVictoryBGM(struct TrainerData *trainer)
{
    ...
    case TRAINERCLASS_GARDENIA:
    case TRAINERCLASS_ROXIE:
    ...
    case TRAINERCLASS_TAU:
    case TRAINERCLASS_ELITE_FOUR_KOGA:
    case TRAINERCLASS_ELITE_FOUR_BRUNO:
    case TRAINERCLASS_LEADER_BROCK:
    case TRAINERCLASS_VOLKNER:
    case TRAINERCLASS_DUSKNOIR:
    case TRAINERCLASS_HANNAH:
    case TRAINERCLASS_GHETSIS:
    case TRAINERCLASS_ZINZOLIN:
    case TRAINERCLASS_COLRESS:
    case TRAINERCLASS_LEADER_BLUE:
        PlayBGM(SEQ_GS_WIN3);
        break;
    case TRAINERCLASS_DARKRAI:
    case TRAINERCLASS_CYRUS:
    case TRAINERCLASS_JUPITER:
    case TRAINERCLASS_SATURN:
    case TRAINERCLASS_MARS:
