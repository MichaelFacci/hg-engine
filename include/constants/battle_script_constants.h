...
#define SUB_SEQ_CANNOT_BELCH                           (502)
...
#define ADD_STATUS_EFF_BOOST_STATS_SPEED_UP_6        (193)
#define ADD_STATUS_EFF_ADD_TYPE_GRASS                (194)
#define ADD_STATUS_EFF_ADD_TYPE_GHOST                (195)
#define ADD_STATUS_EFF_CHANGE_TARGET_TO_PSYCHIC_TYPE (196)
#define ADD_STATUS_EFF_AURORA_VEIL                   (197)
#define ADD_STATUS_EFF_STRENGTH_SAP                  (198)
#define ADD_STATUS_EFF_HEAL_PULSE                    (199)
#define ADD_STATUS_EFF_POLLEN_PUFF_HEAL              (200)
#define ADD_STATUS_EFF_COACHING                      (201)
#define ADD_STATUS_EFF_LIFE_DEW                      (202)
#define ADD_STATUS_EFF_ENTRAINMENT                   (203)
#define ADD_STATUS_EFF_HOWL                          (204)
#define ADD_STATUS_EFF_DECORATE                      (205)
#define ADD_STATUS_EFF_PARTING_SHOT                  (206)
#define ADD_STATUS_EFF_CLEAR_SMOG                    (207)
#define ADD_STATUS_EFF_FLAME_BURST_HIT               (208)
#define ADD_STATUS_EFF_ION_DELUGE                    (209)
#define ADD_STATUS_EFF_REMOVE_USER_FIRE_TYPE         (210)
#define ADD_STATUS_EFF_REMOVE_USER_ELECTRIC_TYPE     (211)
